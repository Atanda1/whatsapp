			...
			<div class="Chatroom">
				<div class="Chatroom__list">
					<div class="Chatroom__list__profile">
						<img class="Chatroom__list__profile__img" src="">
						<svg id="df9d3429-f0ef-48b5-b5eb-f9d27b2deba6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="Chatroom__list__profile__chat">
						...
						<svg xmlns="http://www.w3.org/2000/svg" class="Chatroom__list__profile__chat" viewBox="0 0 24 24" >
						...
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="Chatroom__list__profile__chat">
					...
					<div class="Chatroom__list__search">
						<input type="text" placeholder=' Search or start a new chat' />
					</div>
					<div class="Chatroom__list__">
						<div class="Chatroom__list__messages">
				...
				<div class="Chatroom__details">		
					<div class="Chatroom__details__userprofile">
						<img class="Chatroom__details__userprofile__img" src="">
						<div class="Chatroom__details__userprofile__name" >Supreme</div>
						<img class="Chatroom__details__userprofile__chat" src="../assets/search-header.svg">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="Chatroom__details__userprofile__chat">
							<path fill="currentColor" d="M12 7a2 2 0 1 0-.001-4.001A2 2 0 0 0 12 7zm0 2a2 2 0 1 0-.001 3.999A2 2 0 0 0 12 9zm0 6a2 2 0 1 0-.001 3.999A2 2 0 0 0 12 15z"></path>
						</svg>
					</div>
					<div class="Chatroom__details__chat">
						<div class="Chatroom__details__chat__received tri-right left-top"><p>If you have one bucket<span>1:00PM</span></p></div>
						<div class="Chatroom__details__chat__received"><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.<span>1:20PM</span></p></div>
						<div class="Chatroom__details__chat__sent  tri-right right-top"><p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).<span>1:20PM</span></p></div>	
					</div>
					<div class="Chatroom__details__message">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="Chatroom__details__message__svg">
						...
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="Chatroom__details__message__svg mr-auto">
						...
						<input class="Chatroom__details__message__input" type="text" placeholder=' Type a message' />
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="Chatroom__details__message__svg mr-auto">
